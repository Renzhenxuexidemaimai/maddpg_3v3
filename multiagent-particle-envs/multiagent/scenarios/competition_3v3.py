...
class Scenario(BaseScenario):
    ...
    def get_agents_win_state(self):
        return self.red_win, self.red_leave, self.invalid_train, self.green_win, self.green_leave
    ...
    def observation(self, agent, world):
        ...
        return np.concatenate([agent.state.p_vel] + [
            agent.state.p_pos] + entity_pos + other_pos + other_vel + our_chi + other_chi + action_number)
